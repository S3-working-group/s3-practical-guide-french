---
title: "Prise de Décision Raisonnée"
next_page_title: "Attribution de Rôles"
next_page_url: "role-selection.html"
prev_page_title: "Élaborer une Proposition"
...
-   [La prise de décision par consentement](consent-decision-making.html), est pour vérifier si une proposition ou un accord existant est suffisant et assez sûr. Et, à l'intérieur de cela, deux pratiques imbriquées :
-   [Examiner les Objections](test-arguments-qualify-as-objections.html), pour tester si les arguments se qualifient comme des objections et n'agir que sur ceux-là.
-   [Résoudre les Objections](resolve-objections.html), pour utiliser les informations révélées par les objections afin de conclure et de faire évoluer les accords.
