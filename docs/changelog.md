...
next_page_title: "Liste alphabétique de toutes les pratiques"
next_page_url: "pattern-index.html"
prev_page_title: "Annexe"
...
- Création d'un chapitre séparé pour Structurer une Organisation, 
    - ajout de [Organisation Décentralisée](peach-organization.html), [Organisation de Service](service-organization.html), [Organisation Fractale](fractal-organzition.html) and [Hiérarchie à Double Lien](double-linked-hierarchy.html) comme exemples de structures plus grandes.
    - déplacement de [Cercle Délégué](delegate-circle.html) et [Cercle de Service](service-circle.html) vers [Bâtir des Organisations](building-organizations.html)
...
- renommage de *Transparence salariale* en [Salaire Ouvert](open-salary.html)

**Pratiques ajoutées:** (toutes avec un bref résumé pour le moment)

- [Collaborer sur les Dépendances](collaborate-on-dependencies.html)
- [Délivrer la Valeur par Incrément](deliver-value-incrementally.html)
- [Concevoir des Systèmes Adaptatifs](design-adaptable-systems.html)
- [Cultiver l'Autonomie](enable-autonomy.html)
- [Transparence Financière](financial-transparency.html)
- [Investir dans l'Apprentissage Perpétuel](invest-in-ongoing-learning.html)
- [Gérer l'Ensemble du Système](manage-the-whole-system.html)
- [Partager les Coûts et les Gains](share-costs-and-gains.html)
...
- a ajouté une description détaillée et de nouvelles illustrations à [Examiner les Objections](test-arguments-qualify-as-objections.html)

## Changements du 05-04-2022

- Ajout d'une description détaillée et de nouvelles illustrations à [Résoudre les Objections](resolve-objections.html)

## Changements du 04-02-2022

- description détaillée ajoutée du processus [Prise de décision par consentement](consent-decision-making.html)
- texte révisé pour [Prise de Décision Raisonnée](reasoned-decision-making.html)
...
- Ajout de [Prise de Décision Raisonnée](reasoned-decision-making.html)
...
- texte révisé à propos de [Objections](objection.html) ainsi que les définitions de <a href="glossary.html#entry-objection" class="glossary-tooltip" data-toggle="tooltip" title="Objection: Un argument – relatif à une proposition, un accord existant, ou une activité menée par un ou plusieurs membres de l&#x27;organisation - révélant des conséquences ou des risques qu&#x27;il serait préférable d&#x27;éviter pour l&#x27;organisation, ou démontrant des améliorations potentielles significatives.">Objection</a> et <a href="glossary.html#entry-concern" class="glossary-tooltip" data-toggle="tooltip" title="Préoccupation: Une supposition qui ne peut (du moins pour le moment) être étayée par un raisonnement ou par suffisamment de preuves être considérée comme une objection à ceux qui la considèrent.">Préoccupation</a>

## Changements du 15-08-2021

- Renommé *Domaine Ouvert* en [Équipe Ouverte](open-team.html)
...
- Une nouvelle structure du Guide Pratique pour retrouver plus facilement les parties pertinentes. 
    ...
    - [Concepts clés pour comprendre les organisations](making-sense-of-organizations.html)
    - [Les Pratiques](patterns.html)
    - [Le Framework du Sens Commun](csf.html)
    - [Annexe](appendix.html)
...
- [Clarifier et Affiner les Domaines](clarify-and-develop-domains.html): texte révisé, ajout de plus de détails et d'explications sur les descriptions de domaine
- [Évaluation entre Pairs](peer-review.html) : ajout de plus de détails sur ce qui doit être évalué
- [Retour entre Pairs](peer-feedback.html): révision du texte et ajout de plus de détails
...
- pratique *Objection* renommée en [Examiner les Objections](test-arguments-qualify-as-objections.html)
- pratique *Accord* renommée en [Consigner les Accords](record-agreements.html)
- [Examiner les Objections](test-arguments-qualify-as-objections.html) : texte révisé et illustration mise à jour
...
- [Cercle Délégué](delegate-circle.html) : résumé raffiné
...
- [Élaborer une proposition](proposal-forming.html) : ajout d'une illustration de processus manquante
- [Attribution de Rôles](role-selection.html) : petit amendement à l'illustration
- [Transparence Salariale](open-salary.html): explication de ce qu’est une formule salariale
...
- [S'Accorder sur des Valeurs](agree-on-values.html) : description améliorée
...
- [Décider par consentement](consent-decision-making.html): description améliorée, illustration mise à jour
...
- [Critères d'Évaluation](evaluation-criteria.html): suggéré de clarifier un seuil de réussite, et nous avons expliqué que nous faisons évoluer également les critères d'évaluation avec les accords
...
- [Espace de Changement Ouvert](open-space-for-change.html): nouveau nom de *Adoption ouverte de la S3*, description améliorée
- [Organisation décentralisée](peach-organization.html): relation clarifiée entre la périphérie et le centre
...
- [Transparence salariale](open-salary.html): ajout de plus de détails sur l'équité, et sur la façon de développer une formule salariale
...
- [Allouer des Blocs de Temps](timebox-activities.html)
