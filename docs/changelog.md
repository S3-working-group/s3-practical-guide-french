...
- [Clarifier et développer les domaines](clarify-and-develop-domains.html): texte révisé, ajout de plus de détails et d'explications sur les descriptions de domaine
- [Évaluation par les pairs](peer-review.html): ajout de plus de détails sur ce qui doit être évalué
- [Retour par les pairs](peer-feedback.html): révision du texte et ajout de plus de détails
...
- [Backlog (panier) de gouvernance](governance-backlog.html): description améliorée
