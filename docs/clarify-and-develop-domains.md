---
title: "Clarifier et développer les domaines"
---
...
Envisagez de clarifier les domaines chaque fois que vous identifiez que les parties prenantes ont des attentes différentes sur le domaine actuel d'un [rôle](role.html), poste, équipe, service ou unité, voire même sur le domaine de l'organisation dans son ensemble.
...
En plus du résumé, d'autres détails sur le driver peuvent être conservés dans le [registre](logbook.html)
...
-   Un processus d'évaluation (par exemple [Évaluation par les pairs](peer-review.html)).
-   Pensez à inclure une date de fin (pour un rôle).

Veillez à ajoutez au [registre](logbook.html) les dates auxquelles un domaine doit être revu et à surveiller ces échéances.
...
<a href="clarify-and-develop-strategy.html" title="Back to: Clarifier et développer la stratégie">◀</a> <a href="defining-agreements.html" title="Up: Élaborer des accords">▲</a> <a href="clarify-intended-outcome.html" title="">▶ Read next: Clarifier le résultat attendu</a>
</div>
