...
Vous pouvez décrire le driver primaire en utilisant la pratique [Décrire les Drivers Organisationnels](describe-organizational-drivers.html) et regarder la pratique [Répondre aux Drivers Organisationnels](respond-to-organizational-drivers.html) pour des suggestions sur la façon de décrire cette exigence.
