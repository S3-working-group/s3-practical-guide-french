...
Les propositions deviennent des <dfn data-info="Entente: Une ligne directrice, un processus ou protocole établi de le but de guider le flux de valeur.">ententes</dfn> quand elles sont considérées *suffisamment bonnes pour l'instant et suffisamment sûres à essayer* jusqu'à la prochaine évaluation.
