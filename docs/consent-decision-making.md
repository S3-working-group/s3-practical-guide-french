...
next_page_title: "Examiner les Objections"
next_page_url: "test-arguments-qualify-as-objections.html"
prev_page_title: "Déterminer les Exigences"
...
Tous les arguments présentés ne sont pas des objections, mais ils peuvent révéler des [préoccupations](objection.html) :
...
Voir la pratique [Examiner les Objections](test-arguments-qualify-as-objections.html) pour plus de détails.
...
Voir la pratique [Résoudre les Objections](resolve-objections.html) pour plus de détails.
