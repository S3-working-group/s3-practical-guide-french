...
- Un **besoin d'une organisation** est tout ce qu'une équipe (ou une personne) nécessite pour s'occuper efficacement d'un <dfn data-info="Domaine: Une zone d&apos;influence, activité et prise de décisions distincte au sein d&apos;une organisation.">domaine</dfn>. 
