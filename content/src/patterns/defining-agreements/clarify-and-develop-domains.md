...
Envisagez de clarifier les domaines chaque fois que vous identifiez que les parties prenantes ont des attentes différentes sur le domaine actuel d'un [rôle](section:role), poste, équipe, service ou unité, voire même sur le domaine de l'organisation dans son ensemble.
...
En plus du résumé, d'autres détails sur le driver peuvent être conservés dans le [registre](section:logbook)
...
Les [Indicateurs](glossary:metric) clés sont des mesures critiques de progrès. Ils concernent le driver primaire (et/ou la raison d’être), les responsabilités clés, les défis, les livrables et les responsabilités du délégant définies pour ce domaine.
...
-   Un processus d'évaluation (par exemple [Évaluation par les pairs](section:peer-review)).
-   Pensez à inclure une date de fin (pour un rôle).

Veillez à ajoutez au [registre](section:logbook) les dates auxquelles un domaine doit être revu et à surveiller ces échéances.
