...
L'équivalence doit être équilibrée avec l'[Efficacité](section:principle-effectiveness), la [Transparence](section:principle-transparency) et contrainte par  le [Consentement](section:principle-consent), pour qu'elle fonctionne au mieux. Il est important de bien peser le degré de participation par rapport au coût en termes de ressources, d'énergie et de temps.
